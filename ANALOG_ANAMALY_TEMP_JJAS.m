...
for m = im:im % 1:4
    ...
    for m = 1:NUM_ANA
        ...
        tmp1 = squeeze(all_data(squeeze(ANA(:,m)-1978),2,im));
    ...
    ylabel('Correlation skill for High FT')
    xlim([1 10])
    set(gca,'xtick',1:10)
    grid on
    stop
